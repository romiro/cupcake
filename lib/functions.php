...
/**
 * Autoloader for unincluded classes
 *
 * @param string $c
 */
function __autoload($c)
{
    require_once(BASEDIR . "/lib/$c.php");
}
...
/**
 * Used to print out style attributes for elements that have been repositioned
 *
 * @param string $type
 * @return string
 */
...
/**
 * Shortcut to create an img element with a given silkicon
 *
 * @param string $name
 * @return string
 */
